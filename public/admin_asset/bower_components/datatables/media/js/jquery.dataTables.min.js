...
g.fn.dataTable=p;g.fn.dataTableSettings=p.settings;g.fn.dataTableExt=p.ext;g.fn.DataTable=function(a){return g(this).dataTable(a).api()};g.each(p,function(a,b){g.fn.DataTable[a]=b});return g.fn.dataTable};"function"===typeof define&&define.amd?define("datatables",["LaravelDemo/resources/views/admin/bower_components/datatables/media/js/jquery"],O):"object"===typeof exports?O(require("LaravelDemo/resources/views/admin/bower_components/datatables/media/js/jquery")):jQuery&&!jQuery.fn.dataTable&&O(jQuery)})(window,document);
